  ...
  code?: string
    ...
    <html lang="en">
      <head>
        ...
        <title>${title} - Techstudio Academy</title>
        <style>
          ...
          .top-banner {
            height: 4px;
            background: linear-gradient(90deg, #0266F4 0%, #1F2666 100%);
          }
          ...
          .button {
            ...
            box-shadow: 0 4px 14px rgba(2, 102, 244, 0.3);
          }
          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <p style="font-size: 13px; color: #9CA3AF; line-height: 1.5; margin: 0;">
                Didn't expect this email? No worries \u2014 just ignore it and we'll leave you alone.
              </p>
            </div>
            ...
            <div class="footer">
              ...
              <p style="margin: 0 0 8px;">
                \u00a9 ${new Date().getFullYear()} Techstudio Academy. All rights reserved.
              </p>
...
export const verifyAccountTemplate = (code: string, actionLink?: string, name?: string) =>
  baseLayout(
    'Verify Your Email',
    name || 'Admin',
    `
      Welcome to <strong>Techstudio Academy Portfolio</strong> \u2014 we're glad you're here!
...
export const resetPasswordTemplate = (resetLink: string, name?: string) =>
  baseLayout(
    'Reset Your Password',
    name || 'Admin',
    `
