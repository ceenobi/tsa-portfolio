...
const ABOUT_LINKS = [
	...
	{
		name: "Careers",
		href: "https://www.techstudioacademy.com/careers",
	},
];
...
const SOCIALS = [
	{
		label: "Twitter",
		href: "https://x.com/techstudioacdmy",
	...
	return (
		<footer className="bg-blue-950 text-white">
			<div className="mx-auto max-w-7xl px-4 py-12 lg:py-15 sm:px-6 lg:px-25">
				...
				<div className="mt-10 border-t-[1.4px] border-white pt-6 flex flex-col sm:flex-row justify-between items-center gap-6 md:gap-0">
