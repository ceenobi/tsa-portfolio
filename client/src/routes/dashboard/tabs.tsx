...
export const Tabs = [
  {
    ...
    iconActive: <img src={DashboardIconActive} alt="Portfolio Icon" className="w-6 h-6" />,
  },
  {
    key: "portfolio",
    label: "Portfolio",
    icon: <img src={PortfolioIcon} alt="Portfolio Icon" className="w-6 h-6" />,
    iconActive: <img src={PortfolioIconActive} alt="Portfolio Icon" className="w-6 h-6" />,
  },
  {
    key: "settings",
    label: "Settings",
