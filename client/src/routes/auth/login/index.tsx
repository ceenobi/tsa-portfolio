...
import { loginSchema, type AuthResponse } from "@tsa/shared";
  ...
  return (
    <div className="space-y-8 w-full max-w-[85vw]">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 w-full">
        ...
        />
        <Link to="/auth/forgot-password" className="text-sm font-semibold text-deepBlue hover:underline">Forgot Password?</Link>
        </div>
        <ActionBtn
          text="Login"
          type="submit"
