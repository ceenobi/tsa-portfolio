...
import { type ResetPasswordResponse, resetPasswordSchema } from "@tsa/shared";
...
export default function ResetPassword() {
	...
	const mutation = useMutation({
		mutationFn: (data: z.infer<typeof ResetPasswordSchema>) => {
			return api.post<ResetPasswordResponse["body"]>(
		...
		<div className="space-y-8">
			<div className="mt-4 space-y-1">
				...
				<p className="text-sm md:text-base text-mainGray">
					{" "}
					Choose a strong password you haven't used before. Make it at least 8
					characters.
				</p>
			</div>
